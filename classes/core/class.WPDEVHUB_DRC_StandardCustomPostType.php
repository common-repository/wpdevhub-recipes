 ...
 */
class WPDEVHUB_DRC_StandardCustomPostType{
    ...
    public static function get_display($content){
        WPDEVHUB_DRC_Utilities::logMessage("get_display.  Wrong place to be - in the parent");
        return $content;
    }
    ...
    public static function getAllPostObjectsAsMenuArray(){
        ...
        $array = WPDEVHUB_DRC_StandardObjectRecord::getBasicArrayFromObjects($posts, 'post_title', 'ID');
        return $array;
    }
    ...
    */
    ...
    public static function getVirtualPagesPostList($params){
        ...
        WPDEVHUB_DRC_Utilities::logMessage("PAGINATION VARS: ".print_r($paginationVars, true));
        $pagination = get_the_posts_pagination($paginationVars);
        $html .= $pagination;
        WPDEVHUB_DRC_Utilities::logMessage("PAGINATION: ".$pagination);
        */
    ...
    */
    public static function shortcodeHandlerDisplayGenericPostType($atts, $id_field){
        ...
        $post_id = WPDEVHUB_DRC_Utilities::getFromArray($id_field, $data, 0);
    ...
    public static function helperBuildTitleArrayForParentId($parentPostObject, $postsByParent){
        ...
        $childPosts = WPDEVHUB_DRC_Utilities::getFromArray($parentPostObjectId, $postsByParent);
        //WPDEVHUB_DRC_Utilities::logMessage("helperbuildIdentificationArrayForParentId Child Identifications Found for ParentID[$parentPostObjectId]: ".print_r($childPosts, true));
        ...
        if(!empty($childPosts)){
            ...
            //WPDEVHUB_DRC_Utilities::logMessage("helperbuildIdentificationArrayForParentId BEFORE SORT Array: ".print_r($childPosts, true));
            ...
            //WPDEVHUB_DRC_Utilities::logMessage("helperbuildIdentificationArrayForParentId AFTER SORT Array: ".print_r($childPostsBySlug, true));
        ...
        //WPDEVHUB_DRC_Utilities::logMessage("helperbuildIdentificationArrayForParentId Return Array: ".print_r($returnArray, true));
    ...
    public static function helperSortPostsByHierarchy($posts){
        ...
        //WPDEVHUB_DRC_Utilities::logMessage("Unsorted Identifications Only By Parent ID: ".print_r($postsByParent, true));
        ...
        //WPDEVHUB_DRC_Utilities::logMessage("Sorted Identifications By Parent ID: ".print_r($finalArray, true));
    ...
    public static function getPostsWithHierarchyForMenu($sortedPosts, $menuArray=array(), $existingPrefix=""){
        ...
        //WPDEVHUB_DRC_Utilities::logMessage("Sorted Identifications Passed in: ".print_r($sortedPosts, true));
        foreach($sortedPosts as $postArray){

            $post = WPDEVHUB_DRC_Utilities::getFromArray('location', $postArray, null);
            $children = WPDEVHUB_DRC_Utilities::getFromArray('children', $postArray, array());
        ...
        //WPDEVHUB_DRC_Utilities::logMessage("Menu Array Being Return: ".print_r($menuArray, true));
        return $menuArray;
