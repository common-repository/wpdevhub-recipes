...
var WPDEVHUB_DRC_Admin = {
    ...
    loadGoogle:function(){
        if(WPDEVHUB_DRC_Charts.isGoogleLoaded){
            ...
            script.src = "https://www.google.com/jsapi?callback=WPDEVHUB_DRC_Charts.loadGoogleVisualization";
    ...
    loadGoogleVisualization:function(){
        ...
        if(WPDEVHUB_DRC_Charts.isGoogleVisLoaded){
            ...
            google.load("visualization", "1", {'packages':['corechart','annotationchart','gauge', 'timeline', 'bar'], "callback" : WPDEVHUB_DRC_Charts.drawGoogleCharts});
        }
    },
    ...
    addChart:function(elementId, chartTypeId, data, options){
        ...
        newChart.data = data;
        newChart.options = options;
        WPDEVHUB_DRC_Charts.chartsToDo.push(newChart);
        WPDEVHUB_DRC_Charts.drawGoogleCharts();
    },
    ...
    drawGoogleCharts:function(){
        ...
        setTimeout(function(){
            ...
            while(WPDEVHUB_DRC_Charts.chartsToDo.length > 0){
                var chartObject = WPDEVHUB_DRC_Charts.chartsToDo[0];
                ...
                WPDEVHUB_DRC_Charts.arrayRemove(WPDEVHUB_DRC_Charts.chartsToDo, 0);
            }
        }, 500);
    },
    ...
    this.performAjax = function(){
        ...
        $.ajax({
            ...
            success: function(responseData) {
                ...
                WPDEVHUB_DRC_Charts.chartsToDo.push(this.chartObject);
                WPDEVHUB_DRC_Charts.drawGoogleCharts();
            },
